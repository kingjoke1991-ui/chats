...
class Settings(BaseSettings):
    ...
    qiandu_intel_signal_threshold: int = Field(default=2, alias="QIANDU_INTEL_SIGNAL_THRESHOLD")
    qiandu_total_budget_seconds: int = Field(default=240, alias="QIANDU_TOTAL_BUDGET_SECONDS")
    qiandu_provider_concurrency: int = Field(default=2, alias="QIANDU_PROVIDER_CONCURRENCY")
    qiandu_local_tool_concurrency: int = Field(default=1, alias="QIANDU_LOCAL_TOOL_CONCURRENCY")
    qiandu_intel_task_concurrency: int = Field(default=3, alias="QIANDU_INTEL_TASK_CONCURRENCY")
    qiandu_crawl4ai_concurrency: int = Field(default=2, alias="QIANDU_CRAWL4AI_CONCURRENCY")
    qiandu_crawl4ai_shared_browser: bool = Field(default=True, alias="QIANDU_CRAWL4AI_SHARED_BROWSER")
